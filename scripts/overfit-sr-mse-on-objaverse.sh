...
# out_name=${scene_name}_${alignment}_${attribute_init}_if${input_factor}_tf${target_factor}_mse_${loss_name}_pa${post_activate_bit}_direct${direct_prediction_bit}
# output_dir=/project/ricky/experiments/objaverse_splatformer_overfit_sr_mse_512/${out_name}

# CUDA_VISIBLE_DEVICES=$GPU_ID python overfit-sr-mse-old.py \
#     --output_dir=${output_dir} \
#     --scene_name=${scene_name} \
#     --alignment=${alignment} \
#     --attribute_init=${attribute_init} \
