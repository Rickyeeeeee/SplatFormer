...
out_name=${scene_name}_${alignment}_${attribute_init}_if${input_factor}_tf${target_factor}_gsfm_all_${mix_schedule}
output_root=${OUTPUT_ROOT:-/project2/ricky/experiments/0815-unified/overfit_sr_gsfm_512}
