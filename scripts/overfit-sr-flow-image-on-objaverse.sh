...
OUTPUT_ROOT=${OUTPUT_ROOT:-/project/ricky/outputs/objaverse_splatformer_overfit_sr_flow_image512_progressive}
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python overfit-sr-flow-image.py \
