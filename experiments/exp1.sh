...
GPU_ID=3 bash scripts/overfit-sr-mse-on-objaverse.sh 1000 200 200 200 emd aligned 4 2 means
...
GPU_ID=3 bash scripts/overfit-sr-mse-on-objaverse.sh 1000 200 200 200 emd aligned 4 1 features_dc
GPU_ID=3 bash scripts/overfit-sr-mse-on-objaverse.sh 1000 200 200 200 emd aligned 4 1 features_rest
GPU_ID=3 bash scripts/overfit-sr-mse-on-objaverse.sh 1000 200 200 200 emd aligned 4 1 quats
GPU_ID=3 bash scripts/overfit-sr-mse-on-objaverse.sh 1000 200 200 200 emd aligned 4 1 means,opacities,features_dc,features_rest,scales,quats
